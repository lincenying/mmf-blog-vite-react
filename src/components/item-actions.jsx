...
export default function ItemActions(props) {
    ...
    const handleLike = async () => {
        ...
        if (code === 200) {
            ...
            dispatch({ type: 'topics/updateTopicsLikeState', payload: { id: item._id } })
    ...
    return (
        <div className="actions-wrap">
            <a onClick={handleLike} href={null} className={item.like_status ? 'action-item active' : 'action-item'}>
            ...
            <a onClick={handleShare} href={null} className="action-item">
